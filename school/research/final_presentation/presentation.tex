...
\begin{document}
    ...
    % PP Slides 15 - 16
    \begin{frame}
        \includegraphics[page=11,width=\textwidth]{original}
    \end{frame}
    \begin{frame}
        \includegraphics[page=12,width=\textwidth]{original}
    \end{frame}
    \begin{frame}
        \includegraphics[page=13,width=\textwidth]{original}
    \end{frame}
    \begin{frame}
        \includegraphics[page=14,width=\textwidth]{original}
    \end{frame}
    ...
    % PP Slides 17 - 21
    \begin{frame}
        \includegraphics[page=15,width=\textwidth]{original}
    \end{frame}
    \begin{frame}
        \includegraphics[page=16,width=\textwidth]{original}
    \end{frame}
    \begin{frame}
        \includegraphics[page=17,width=\textwidth]{original}
    \end{frame}
    \begin{frame}
        \includegraphics[page=18,width=\textwidth]{original}
    \end{frame}
    \begin{frame}
        \includegraphics[page=19,width=\textwidth]{original}
    \end{frame}
